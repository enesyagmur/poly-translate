...
const Image = () => {
  return (
    <div className="w-full md:w-full lg:w-6/12 h-1/2 md:h-full flex flex-col items-center justify-center md:justify-evenly lg:justify-center">
      <div className="w-5/12 md:w-7/12 lg:w-5/12 flex flex-wrap text-center justify-evenly items-center capitilize font-bold sm:text-xl md:text-2xl lg:text-3xl text-white mt-6 md:mt-2">
